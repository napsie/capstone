...
-- Complete Database Schema — carelink_db
...
CREATE TABLE `applications` (
  ...
  `application_type`           enum('pwd','senior','pension','burial') NOT NULL,
  ...
  -- CSV-import supporting document type references (not binary — just labels)
