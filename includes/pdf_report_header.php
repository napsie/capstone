...
function standardPdfReportHeaderCommands(array $report, callable $escape, callable $fit, bool $hasLogo): array {
    ...
    $commands[] = '0.05 0.17 0.32 rg BT /F2 16 Tf 124 551 Td (PASIG CITY) Tj ET';
    $commands[] = 'BT /F1 10.5 Tf 124 532 Td (Office for Senior Citizens Affairs) Tj ET';
    $commands[] = '0.04 0.31 0.22 rg BT /F2 12.5 Tf 124 513 Td (SENIORLINK) Tj ET';
    $commands[] = '0.28 0.35 0.43 rg BT /F3 8.5 Tf 124 499 Td (Centralized Profiling and Record Management System) Tj ET';
